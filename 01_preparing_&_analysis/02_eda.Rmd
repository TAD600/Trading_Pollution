...
imp <- filled_data %>% 
 ...
 annotate('text',x = seq(1995, 2020, 1), y = 0.01, label = seq(1995, 2020, 1), 
  ...
  coord_cartesian(xlim = c(1992, 2020.5), ylim = c(35, 0.01), expand = F) + 
  theme_void(base_size = 12) + 
  labs(title = 'Top ten emission outsourcing countries of 2020') + 
  theme(
...
exp <- filled_data2 %>% 
 ...
 annotate('text',x = seq(1995, 2020, 1), y = 0.01, label = seq(1995, 2020, 1), 
  ...
  scale_x_continuous(breaks = seq(1995, 2020, by = 1)) + 
  coord_cartesian(xlim = c(1993, 2020.5), ylim = c(55, 0.01), expand = F) + 
  theme_void(base_size = 12) + 
  labs(title = 'Top ten emission exporting countries of 2020') + 
  theme(
    legend.position = 'none', 
    plot.background = element_rect(fill = 'white', color = NA), 
    plot.margin = margin(t=2, r=20, b=2, l=5, unit = 'mm'), 
