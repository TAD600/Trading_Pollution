...
## raw 
# This subfolder has 14 csv files
...
## cleaned
# This subfolder has 43 csv files
...
`LTE.csv`: LTE adoptation data prepared from `LTE.xlsx`
`LTE_long.csv`: LTE adoptation data in long format
...
`attributeYEAR.csv': There are 21 files like this name. These are the time varying nodal attributes merged on the fixed attributes created for node attributes of the network objects.
